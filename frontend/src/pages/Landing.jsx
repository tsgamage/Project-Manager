...
export default function LandingPage() {
  ...
  const features = [
    {
      ...
      description: "Monitor project progress with real-time updates, deadline tracking, and milestone management.",
      color: "blue"
    },
    {
      icon: Users,
      title: "Team Collaboration", 
      description: "Seamlessly manage team members, assign roles, and foster collaborative workflows.",
      color: "green"
    },
    {
      icon: BarChart3,
      title: "Analytics Dashboard",
      description: "Gain insights with productivity metrics, completion rates, and performance analytics.",
      color: "purple"
    },
    {
      icon: Zap,
      title: "Task Management",
      description: "Organize tasks by categories, set priorities, and track completion status efficiently.",
      color: "orange"
    }
  ];
  ...
  const benefits = [
    {
      ...
      description: "Increase team efficiency by up to 40% with streamlined workflows and automated task tracking.",
      icon: TrendingUp,
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      title: "Save Time",
      description: "Reduce project management overhead by 60% with intelligent automation and smart notifications.",
      icon: Clock,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      {/* Navigation Header */}
      <nav className="top-0 left-0 right-0 z-50 p-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link 
            to="/auth/login"
            className="group flex items-center gap-2 px-6 py-3 glass rounded-xl text-white font-medium hover:bg-white/10 transition-all duration-300 hover-lift border border-white/20 backdrop-blur-md"
          >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-blue-500/30 mb-8">
              ...
              <span className="text-smmd font-medium text-blue-300">Next-Gen Project Management</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              ...
              <span className="bg-gradient-to-r from-blue-400 to-green-400 bg-clip-text text-transparent"> Modern Teams</span>
            </h2>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 transition-all duration-300 ${
                  activeFeature === index 
                    ? feature.color === 'blue' ? 'gradient-blue' 
                      : feature.color === 'green' ? 'gradient-green'
                      : feature.color === 'purple' ? 'bg-gradient-to-br from-purple-500 to-pink-500'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                  Why Choose Our
                  <span className="bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent"> Platform?</span>
                </h2>
                <p className="text-xl text-gray-400">
                  Experience the difference with features designed for modern teams who demand excellence.
                </p>
              </div>

              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-start gap-6 group">
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${benefit.gradient} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="glass rounded-2xl p-8 hover:bg-white/5 transition-all duration-300 hover-lift">
                {/* Rating */}
