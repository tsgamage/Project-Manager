              ...
              Project Manager
                    ...
                    <div className="relative flex-1 max-w-2xl mx-6">
                        <div
                            ...
                            />
                            <div
                                className="hidden sm:flex items-center mr-4 px-2 py-1 text-xs rounded bg-stone-700 text-stone-300 border border-stone-600">
                                Ctrl+K
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="relative" ref={dropdownRef}>
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <div
                                        className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 rounded-full border-2 border-stone-900"></div>
                                </div>
                  ...
                  User Name
                            ...
                            {isDropdownOpen && (
                                <div
                                    className="absolute right-0 mt-2 w-64 bg-stone-800 rounded-lg shadow-lg border border-stone-700 overflow-hidden z-50">
                                    <div className="px-4 py-3 border-b border-stone-700">
                                        <p className="text-sm font-medium text-stone-200">User Name</p>
                                        <p className="text-sm text-stone-400 truncate">user@example.com</p>
                                    </div>
                                    ...
                                    <div className="py-1 border-t border-stone-700">
                                        <button
                                            className="w-full text-left px-4 py-2 text-sm text-stone-300 hover:bg-stone-700 hover:text-red-500">
                                            Sign out
                                        </button>
                                    </div>
                                </div>
