...
export default function TaskItem({ task, onToggle, onDelete, onSave }) {
  ...
  return (
    <>
      ...
      <div
        className={`p-4 rounded-lg border transition-all duration-300 ${!isEditing && task.completed ? "bg-green-500/10 border-green-500/30" : "bg-gray-700/50 border-gray-600"}`}
      >
