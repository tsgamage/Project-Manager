...
export default function ProjectInfo({ onEdit }) {
  ...
  return (
    <div className="glass rounded-2xl shadow-lg border border-gray-700 p-2 sm:p-4 overflow-hidden">
      <div className="flex flex-col md:flex-row">
        <div className="flex-1 p-2">
          <div className="mb-5">
            ...
            <p className="text-sm text-gray-400">See all info about your project</p>
          </div>
