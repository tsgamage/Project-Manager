...
export default function Sidebar({ isSidebarOpen, onClose }) {
  ...
  return (
    <aside
      ...
      } md:translate-x-0 fixed md:static inset-y-0 left-0 z-50 md:z-0 w-72 bg-stone-800 border-r border-stone-700 transition-transform duration-300 ease-in-out overflow-y-auto h-screen`}
    >
      {/* Sticky header outside the padded container */}
      <div className="flex justify-between items-center sticky top-0 z-10 bg-stone-800 p-4 md:p-6 pb-2 pt-1">
