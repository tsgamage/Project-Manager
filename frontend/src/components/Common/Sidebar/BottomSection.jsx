    ...
    <div className="border-t border-gray-700 glass flex-shrink-0">
      <div className="p-4 space-y-4">
        ...
        {!isDesktopSideBarCollapsed ? (
          <Link to="/project/new" className="cursor-pointer w-full flex items-center justify-center px-3 py-3 gradient-blue hover:shadow-lg text-white rounded-xl transition-all duration-300 font-medium text-sm hover-lift">
